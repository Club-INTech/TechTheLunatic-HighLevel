...
public class PutBalls extends AbstractScript {
    ...
    @Override
    public void execute(int versionToExecute, GameState actualState, ArrayList<Hook> hooksToConsider) throws UnableToMoveException, BlockedActuatorException {
        try{
            if (versionToExecute==0){
                ...
                //Reculer un peu
                actualState.robot.moveLengthwise(-100);  //TODO: distance ?
